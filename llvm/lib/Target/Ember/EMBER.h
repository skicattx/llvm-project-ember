...
//   FunctionPass *createEMBERISelDag(EMBERTargetMachine &TM);
//   FunctionPass *createEMBERDelaySlotFillerPass();
// 
//   void LowerEMBERMachineInstrToMCInst(const MachineInstr *MI,
//                                       MCInst &OutMI,
//                                       AsmPrinter &AP);
} // end namespace llvm;
...
/*
  ...
  inline static const char *EMBERCondCodeToString(SPCC::CondCodes CC) {
    switch (CC) {
